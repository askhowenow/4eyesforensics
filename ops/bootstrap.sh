...
apt-get update
apt-get install -y python3-venv python3-pip nginx curl snapd openssl certbot python3-certbot-nginx
...
if [ ! -f /etc/letsencrypt/live/4eyesforensics.com/fullchain.pem ]; then
